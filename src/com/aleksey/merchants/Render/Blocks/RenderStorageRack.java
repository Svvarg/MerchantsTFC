...
public class RenderStorageRack implements ISimpleBlockRenderingHandler
{
    ...
    private static final BoundTransform[] _caseBounds = new BoundTransform[] {
        ...
        new BoundTransform(new Bound(Thickness, 1 - Thickness, 0, 1 - Thickness, 1, Thickness),
                new PointF[] {
                    new PointF(0, 0, 1 - Thickness)
                }
            ),
        new BoundTransform(new Bound(0, 1 - Thickness, Thickness, Thickness, 1, 1 - Thickness),
                new PointF[] {
                    new PointF(1 - Thickness, 0, 0),
                }
            )
